...
//* Kompetisi Game
import foto1 from "./../../Assets/dokumentasi-jurusan/hmj/foto-1.jpg";
...
const imageYearData = {
  2021: [
    ...
    {
      src: "https://images.unsplash.com/photo-1560439514-4e9645039924?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fGNvbmZlcmVuY2V8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60",
      ...
      <LayoutTamplate titleHeader={"Dokumentasi Mahasiswa HMJ"}>
        <section className="w-[100%]">
          <Flex className="h-fit flex-col gap-3 inline-block">
            <h3 className="text-[30px] px-10 font-bold">HMJ</h3>
            <Box
              className={`${
                colorMode === "dark"
